...
$(STATEDIR)/classpath.targetinstall:
	...
	@$(call install_copy, classpath, 0, 0, 0644, -, /usr/share/classpath/examples/examples.zip)
	...
	@$(call install_copy, classpath, 0, 0, 0644, -, /usr/lib/classpath/libqtpeer.so)
...
ifdef PTXCONF_PRELINK
	...
	# Startup script
	#
	@$(call install_alternative, classpath-awt-demo, 0, 0, 0755, \
		/etc/init.d/classpath-awt-demo)
	@$(call install_link, classpath-awt-demo, ../init.d/classpath-awt-demo, \
		/etc/rc.d/S95classpath-awt-demo)
