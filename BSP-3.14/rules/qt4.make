...
#
QT4_VERSION	:= 4.7.2
QT4_MD5         := 66b992f5c21145df08c99d21847f4fdb
...
QT4_AUTOCONF += -make examples -make demos -make tools
...
QT4_AUTOCONF += -nomake examples -nomake demos -nomake tools
endif
...
QT4_AUTOCONF += -multimedia
QT4_BUILD_TARGETS += sub-multimedia
QT4_INSTALL_TARGETS += sub-multimedia-install_subtargets
else
QT4_AUTOCONF += -no-multimedia
endif
