...
ifdef PTXCONF_BUSYBOX_FTPD_STARTSCRIPT
	@$(call install_alternative, busybox, 0, 0, 0755, /etc/init.d/ftpd)

ifneq ($(call remove_quotes,$(PTXCONF_BUSYBOX_FTPD_BBINIT_LINK)),)
	@$(call install_link, busybox, \
		../init.d/ftpd, \
		/etc/rc.d/$(PTXCONF_BUSYBOX_FTPD_BBINIT_LINK))
endif
endif
