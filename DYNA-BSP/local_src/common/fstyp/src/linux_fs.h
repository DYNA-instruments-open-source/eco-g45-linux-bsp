...
struct reiserfs_super_block
{
  ...
  u_char  s_state[2];
  u_char  s_magic[12];
  u_char  s_pad[448];           /* The size read by read(2) is 512 bytes,
                                   anything less than that throws a error. */
};
...
#define UFS_SUPER_MAGIC 72020 /* decimal of 0x00011954 (UFS Magic number) */
/* "Sachidananda" <sacchi@gmail.com> Wed Nov  5 23:51:03 IST 2008 */
#define	FS_UFS2_MAGIC	424935705 /* decimal of 0x19540119 (UFS2 magic number) */
#define UFS_DISK_OFFSET_IN_BYTES (8 * 1024)
#define UFS2_DISK_OFFSET_IN_BYTES (64 * 1024)
#define UFS2_PIGGY_OFFSET_IN_BYTES (256 * 1024)

struct ufs_super_block {
  u_char     s_dummy[0x55c];    /* Ignore all the other superblock data  */
  int32_t    s_magic;
  u_char     s_pad[160];
};
